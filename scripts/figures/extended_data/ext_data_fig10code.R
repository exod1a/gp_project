...
# code to make extended data figure 10
...
path <- here("output", "figures", "extended_data", "figure 10")
# save
ggsave(paste(path, "fig10.pdf", sep = "/"), figure, device = "pdf", height = 160, width = 110, units = "mm", dpi = 500)
