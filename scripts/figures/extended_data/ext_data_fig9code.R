...
tipping_elements <- top_taxa[c(5, 46, 28, 61, 62)]
...
path <- here("output", "figures", "extended_data", "figure 9")
dir.create(path)

# save
ggsave(paste(path, "fig9.pdf", sep = "/"), figure, device = "pdf", height = 170, width = 300, units = "mm", dpi = 500)
