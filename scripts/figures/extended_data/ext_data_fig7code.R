...
# bistable taxa
bistable_taxa <- top_taxa[c(12, 32, 46, 63)]
...
path <- here("output", "figures", "extended_data", "figure 7")
dir.create(path)

# save
ggsave(paste(path, "fig7.pdf", sep = "/"), figure, device = "pdf", height = 170, width = 300, units = "mm", dpi = 500)
